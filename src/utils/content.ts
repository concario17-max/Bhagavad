...
export interface TranslationDefinition {
    ...
    content: string;
    className: 'font-inter' | 'font-noto-kr';
}
...
export const getTranslationDefinitions = (verse: GitaVerse): TranslationDefinition[] => {
    const definitions: TranslationDefinition[] = [
        ...
        { id: 'ham', title: 'HAM', content: verse.translation_ham ?? '', className: 'font-noto-kr' },
        { id: 'gil', title: 'GIL', content: verse.translation_gil ?? '', className: 'font-noto-kr' },
        { id: 'jimong', title: 'MYUNG', content: verse.translation_jimong ?? '', className: 'font-noto-kr' },
        { id: 'suk', title: 'SUK', content: verse.translation_suk ?? '', className: 'font-noto-kr' }
    ];
