...
const VersePanelToggle = () => {
    ...
    return (
        <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-gold-primary/20 bg-white/70 px-3 py-2 text-[11px] font-bold uppercase tracking-[0.18em] text-text-secondary transition-colors hover:border-gold-primary/50 hover:text-gold-primary dark:border-dark-border/60 dark:bg-dark-surface/70 dark:text-dark-text-secondary dark:hover:text-gold-light"
